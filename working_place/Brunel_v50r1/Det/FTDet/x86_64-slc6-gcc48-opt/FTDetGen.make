...
ifndef QUICK
$(bin)FTDetGen_dependencies.make : /users/LHCb/abdulkhalek/cmtuser/Brunel_v50r1/Det/FTDet/dict/FTDetDict.h $(use_requirements) $(cmt_final_setup_FTDetGen)
	$(echo) "(FTDetGen.make) Rebuilding $@"; \
	  $(build_dependencies) FTDetGen -all_sources -out=$@ /users/LHCb/abdulkhalek/cmtuser/Brunel_v50r1/Det/FTDet/dict/FTDetDict.h
endif
...
$(gensrcdict) $(rootmapdict) :: $(FTDetDict_h_dependencies) $(FTDet_reflex_selection_file)
	echo $@ FTDetDict.h
	@-mkdir -p $(dictdir)
	$(genreflex_cmd) /users/LHCb/abdulkhalek/cmtuser/Brunel_v50r1/Det/FTDet/dict/FTDetDict.h -o $(gensrcdict) $(FTDetDict_reflex_options)  \
